<%@ Page Language="C#" MasterPageFile="~/SimpleMasterPage.master" AutoEventWireup="true"
                            ...
                            <table border="0" cellpadding="4" cellspacing="0" style="margin:15px" class="NonGridTable">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_User_Name" runat="server" ControlToValidate="txtTenantName"
                                            ErrorMessage="Tenant name is required!" Text="*"></asp:RequiredFieldValidator>
                                        &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"
                                            ControlToValidate="txtTenantName" Text="*" ErrorMessage="Tenant name must have alphabets and digiters. The initial character must be alphabet."
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFValidatorDescription" runat="server" ErrorMessage="Display name is required!"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="License count is required!"
                                            ControlToValidate="txtLicenseNum" Text="*" />
                                        <asp:RangeValidator ID="RVLicenseNum" runat="server" ControlToValidate="txtLicenseNum"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Concurrency count is required!"
                                            ControlToValidate="txtMaxConcurrency" Text="*"/>
                                        <asp:RangeValidator ID="RVMaxConcurrency" runat="server" ControlToValidate="txtMaxConcurrency"
                            ...
                            <table border="0" cellpadding="4" cellspacing="0" class="NonGridTable" style="margin: 5px">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="*" ErrorMessage="Username is required!"
                                            ControlToValidate="txtAdmin"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtAdmin" Text="*"
                                            ErrorMessage="Tenant name must have alphabets and digiters. The initial character must be alphabet." ValidationExpression="^[a-z,A-Z]+[0-9]*[a-z,A-Z]*[0-9]*"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAdminPassword" Text="*"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtAdminPassword" Text="*"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Text="*" ErrorMessage="Email is required!"
                                            ControlToValidate="txtEmail"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Text="*" ControlToValidate="txtEmail"
