<%@ Page AutoEventWireup="true" CodeFile="CreateUser.aspx.cs" Inherits="Admin_Users_CreateUser" Language="C#" MasterPageFile="~/MasterPage.master" %>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0" class="NonGridTable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="ConfirmPasswordRequired" runat="server" ControlToValidate="ConfirmPassword" ErrorMessage="Confirm Password is required." ToolTip="Confirm Password is required." ValidationGroup="CreateUserWizard1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="valRequiredEmail" runat="server" ControlToValidate="Email" ErrorMessage="*" ToolTip="Email is required." ValidationGroup="CreateUserWizard1" />
                        ...
                        <tr>
                            <tdcolspan><asp:CompareValidator id="PasswordCompare" runat="server" ValidationGroup="CreateUserWizard1" ErrorMessage="The Password and Confirmation Password must match." ControlToValidate="ConfirmPassword" Display="Dynamic" ControlToCompare="Password"></asp:CompareValidator><asp:CompareValidator id="ComfirmPasswordCompare" runat="server" ValidationGroup="CreateUserWizard1" ErrorMessage="The Password and Confirmation Password must match." ControlToValidate="ConfirmPassword" Display="Dynamic" ControlToCompare="Password"></asp:CompareValidator>
                        </tr>
                        <tr>
                            <td colspan="2">
